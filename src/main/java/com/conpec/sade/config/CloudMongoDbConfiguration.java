package com.conpec.sade.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.conpec.sade.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.conpec.sade.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.conpec.sade.config.dbmigrations");
