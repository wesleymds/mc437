...
import br.com.conpec.sade.repository.SkillRepository;
import br.com.conpec.sade.repository.search.SkillSearchRepository;
...
public class SkillResourceIntTest {
    ...
    public void createSkill() throws Exception {
        ...
        assertThat(testSkill.isVerified()).isEqualTo(DEFAULT_VERIFIED);
    ...
    public void updateSkill() throws Exception {
        ...
        assertThat(testSkill.isVerified()).isEqualTo(UPDATED_VERIFIED);
